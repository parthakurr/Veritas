...
import { Dumbbell, TrendingUp, Flame, LayoutDashboard, User, LogOut, Menu, X, LogIn } from 'lucide-react';
          ...
          <div className="flex items-center space-x-2">
            {isAuthenticated && user ? (
              <div className="relative">
                ...
                {/* Dropdown Menu Positioned Cleanly */}
                {showDropdown && (
                  <div className="absolute right-0 top-full mt-2 w-48 bg-white dark:bg-slate-900 rounded-2xl p-2 border border-slate-200 dark:border-slate-800 shadow-2xl z-50 text-xs space-y-1">
